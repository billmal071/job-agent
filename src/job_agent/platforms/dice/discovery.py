...
class DiceDiscovery:
    """Handles Dice job search, pagination, and detail extraction."""
    ...
    def search(
        ...
        if experience_level and experience_level.lower() in DICE_EXP_MAP:
            params["filters.experienceLevel"] = DICE_EXP_MAP[experience_level.lower()]
        ...
        while len(jobs) < limit:
            ...
            log.info("dice_page_scraped", page=page_num, jobs_found=len(new_jobs))
    ...
    def _next_page(self) -> bool:
        ...
        try:
            ...
            log.debug("dice_next_page_failed", error=str(e))
        return False
